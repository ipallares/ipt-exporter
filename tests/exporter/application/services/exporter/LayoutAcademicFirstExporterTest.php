...
class LayoutAcademicFirstExporterTest extends KernelTestCase
{
    ...
    {
        $expected = file_get_contents('tests/exporter/application/services/exporter/expected-documents/academic-first-compressed-docx.xml');
    ...
    {
        $expected = file_get_contents('tests/exporter/application/services/exporter/expected-documents/academic-first-extended-docx.xml');
    ...
    {
        $expected = file_get_contents('tests/exporter/application/services/exporter/expected-documents/academic-first-compressed-pdf.xml');
    ...
    {
        $expected = file_get_contents('tests/exporter/application/services/exporter/expected-documents/academic-first-extended-pdf.xml');
